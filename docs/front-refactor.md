...
- `src/app/pages/students_module/enrollments_page` ahora contiene la pantalla de inscripciones / mesas de examen. El componente principal de lógica y UX es `MesasListComponent`, proveniente de la implementación previa, expuesto desde `EnrollmentsPage`.

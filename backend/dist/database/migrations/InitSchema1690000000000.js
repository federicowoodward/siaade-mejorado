...
exports.InitSchema1690000000000 = void 0;
class InitSchema1690000000000 {
    constructor() {
        this.name = "InitSchema1690000000000";
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "address_data" ("id" SERIAL NOT NULL, "street" character varying, "number" character varying, "floor" character varying, "apartment" character varying, "neighborhood" character varying, "locality" character varying, "province" character varying, "postal_code" character varying, "country" character varying, CONSTRAINT "PK_c1379677a0a5f11d46e510491b0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "common_data" ("id" SERIAL NOT NULL, "user_id" uuid NOT NULL, "address_data_id" integer, "sex" character varying, "birth_date" date, "birth_place" character varying, "nationality" character varying, CONSTRAINT "REL_e5f11ef95c7821a3b30897fc9d" UNIQUE ("user_id"), CONSTRAINT "PK_89ec4d90815af0ed75e7fc42076" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "subject_absences" ("id" SERIAL NOT NULL, "subject_id" integer NOT NULL, "student_id" uuid NOT NULL, "dates" date array NOT NULL, CONSTRAINT "PK_ef87b566f7ed9d022b662398dfe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "subjects" ("id" SERIAL NOT NULL, "subject_name" character varying NOT NULL, "teacher" uuid NOT NULL, "preceptor" uuid NOT NULL, "course_num" integer, "course_letter" text, "course_year" text, "correlative" integer, CONSTRAINT "PK_1a023685ac2b051b4e557b0b280" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "exam_table" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "created_by" uuid NOT NULL, CONSTRAINT "PK_7f3870bb63b95ce8bc0a5256464" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "final_exams" ("id" SERIAL NOT NULL, "exam_table_id" integer NOT NULL, "subject_id" integer NOT NULL, "exam_date" date NOT NULL, "aula" character varying, CONSTRAINT "PK_bed2774da6b883bb80b9672d7ed" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "final_exams_students" ("id" SERIAL NOT NULL, "final_exams_id" integer NOT NULL, "student_id" uuid NOT NULL, "enrolled" boolean, "enrolled_at" date, "score" numeric(4,2), "notes" character varying, CONSTRAINT "PK_b7fdfdbde6b37992dbbc2824abc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "students" ("user_id" uuid NOT NULL, "legajo" character varying NOT NULL, CONSTRAINT "UQ_e8df771e580eb1c9f980d27becc" UNIQUE ("legajo"), CONSTRAINT "PK_fb3eff90b11bddf7285f9b4e281" PRIMARY KEY ("user_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "subjects" ADD CONSTRAINT "FK_518c2b43970b993c825ccac1e1d" FOREIGN KEY ("teacher") REFERENCES "teachers"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "subjects" ADD CONSTRAINT "FK_22a0427a54ea60c1542cba37761" FOREIGN KEY ("preceptor") REFERENCES "preceptors"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "exam_table" ADD CONSTRAINT "FK_28c2ce85b8df8b34419f052206b" FOREIGN KEY ("created_by") REFERENCES "secretaries"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "final_exams_students" ADD CONSTRAINT "FK_d8d0547f1caabacb40bfcc743a5" FOREIGN KEY ("final_exams_id") REFERENCES "final_exams"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "final_exams_students" DROP CONSTRAINT "FK_d8d0547f1caabacb40bfcc743a5"`);
        ...
        await queryRunner.query(`ALTER TABLE "exam_table" DROP CONSTRAINT "FK_28c2ce85b8df8b34419f052206b"`);
        ...
        await queryRunner.query(`ALTER TABLE "subjects" DROP CONSTRAINT "FK_22a0427a54ea60c1542cba37761"`);
        await queryRunner.query(`ALTER TABLE "subjects" DROP CONSTRAINT "FK_518c2b43970b993c825ccac1e1d"`);
...
exports.InitSchema1690000000000 = InitSchema1690000000000;
//# sourceMappingURL=InitSchema1690000000000.js.map
...
__decorate([
    (0, typeorm_1.Column)({ name: 'exam_table_id', type: 'int' }),
    __metadata("design:type", Number)
], FinalExam.prototype, "examTableId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => exam_table_entity_1.ExamTable, (et) => et.finals, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'exam_table_id' }),
    __metadata("design:type", exam_table_entity_1.ExamTable)
], FinalExam.prototype, "examTable", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'subject_id', type: 'int' }),
    __metadata("design:type", Number)
], FinalExam.prototype, "subjectId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => subjects_entity_1.Subject, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => final_exams_student_entity_1.FinalExamsStudent, (fes) => fes.finalExam),
    __metadata("design:type", Array)
], FinalExam.prototype, "students", void 0);
exports.FinalExam = FinalExam = __decorate([
    (0, typeorm_1.Entity)('final_exams')
], FinalExam);
//# sourceMappingURL=final_exam.entity.js.map
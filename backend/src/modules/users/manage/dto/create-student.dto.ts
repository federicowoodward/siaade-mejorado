...
import { IsBoolean, IsInt, IsOptional, IsString, ValidateNested, Min } from "class-validator";
...
export class CreateStudentDto extends BaseUserDto {
  ...
  @ApiPropertyOptional({ description: 'Permitir ingreso al sistema', default: true })
  @IsOptional()
  @IsBoolean()
  canLogin?: boolean;

...
export class StudentsReadController {
  ...
  @ApiOperation({ summary: 'Listado de status del alumno en todas las materias (plano)' })
  @ApiParam({ name: 'id', type: String })
  ...
  @ApiOperation({ summary: 'Listado de status de MIS materias (usuario autenticado)' })

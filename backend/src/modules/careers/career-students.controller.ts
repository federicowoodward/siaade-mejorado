...
export class CareerStudentsController {
  ...
  @ApiOperation({
    summary: "Listar alumnos de una carrera con su comision asignada",
  })
  @ApiParam({ name: "careerId", type: Number })
  @ApiQuery({
    name: "q",
    required: false,
    description: "Filtro por nombre, apellido, email o legajo",
  })
  @ApiQuery({
    name: "page",
    required: false,
  ...
  @ApiQuery({
    name: "sort",
    required: false,
    description: "Campo y direccion. Ej: last_name:asc",
  })
  @ApiOkResponse({
    schema: {
      type: "object",

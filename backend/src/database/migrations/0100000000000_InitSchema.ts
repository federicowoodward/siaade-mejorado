...
export class AutoMigration1761015167691 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "exam_table" ("id" SERIAL NOT NULL, "name" text NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, CONSTRAINT "PK_7f3870bb63b95ce8bc0a5256464" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "notices" ("id" SERIAL NOT NULL, "content" text NOT NULL, "visible_role_id" integer, "created_by" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_3eb18c29da25d6935fcbe584237" PRIMARY KEY ("id"))`);

...
export class AutoMigration1761015167691 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "subjects" ("id" SERIAL NOT NULL, "subject_name" text NOT NULL, "academic_period_id" integer, "order_no" integer, "teacher_formation" text, "subject_format" text, "annual_workload" text, "weekly_workload" text, CONSTRAINT "PK_1a023685ac2b051b4e557b0b280" PRIMARY KEY ("id"))`);

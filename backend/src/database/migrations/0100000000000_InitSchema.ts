...
/* incoming_branch_snapshot:
   ...
   export class AutoMigration1761015167691 implements MigrationInterface {
     ...
     public async up(queryRunner: QueryRunner): Promise<void> {
       ...
       await queryRunner.query(
         `CREATE TABLE "common_data" ("id" SERIAL NOT NULL, "user_id" uuid NOT NULL, "address_data_id" integer, "sex" text, "birth_date" date, "birth_place" text, "nationality" text, CONSTRAINT "REL_e5f11ef95c7821a3b30897fc9d" UNIQUE ("user_id"), CONSTRAINT "PK_89ec4d90815af0ed75e7fc42076" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `CREATE TABLE "academic_period" ("academic_period_id" SERIAL NOT NULL, "period_name" text NOT NULL, "partials_score_needed" smallint NOT NULL, CONSTRAINT "PK_c84fec2739f0343e5930990a8c3" PRIMARY KEY ("academic_period_id"))`
       );
       await queryRunner.query(
         `ALTER TABLE "academic_period" ADD CONSTRAINT "CHK_academic_period_partials" CHECK (partials_score_needed = ANY (ARRAY[2,4]))`
       );
       await queryRunner.query(
         `CREATE TABLE "commission" ("id" SERIAL NOT NULL, "commission_letter" text, CONSTRAINT "PK_d108d70411783e2a3a84e386601" PRIMARY KEY ("id"))`
       );
       ...
       await queryRunner.query(
         `CREATE INDEX "IDX_ad9281a6a38148ce7d9674a2a5" ON "subject_commissions" ("subject_id") `
       );
       await queryRunner.query(
         `CREATE UNIQUE INDEX "IDX_b3074a12097b0e46d9a53d0aee" ON "subject_commissions" ("subject_id", "commission_id") `
       );
       await queryRunner.query(
         `CREATE TABLE "subjects" ("id" SERIAL NOT NULL, "subject_name" text NOT NULL, "academic_period_id" integer, "order_no" integer, "teacher_formation" text, "subject_format" text, "annual_workload" text, "weekly_workload" text, CONSTRAINT "PK_1a023685ac2b051b4e557b0b280" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
         `CREATE TABLE "subject_students" ("id" SERIAL NOT NULL, "subject_id" integer NOT NULL, "student_id" uuid NOT NULL, "commission_id" integer, "enrollment_date" date, "enrolled_by" text, CONSTRAINT "CHK_subject_students_enrolled_by" CHECK ("enrolled_by" IS NULL OR "enrolled_by" IN ('student','preceptor','system')), CONSTRAINT "UQ_d7cccb0760404e6dd5ab7732eab" UNIQUE ("subject_id", "student_id"), CONSTRAINT "PK_b877fe7a23fc423266ce05fd3a1" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `CREATE TABLE "exam_table" ("id" SERIAL NOT NULL, "name" text NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "created_by" uuid, CONSTRAINT "PK_7f3870bb63b95ce8bc0a5256464" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
         `CREATE TABLE "final_exams" ("id" SERIAL NOT NULL, "exam_table_id" integer NOT NULL, "subject_id" integer NOT NULL, "exam_date" TIMESTAMP WITH TIME ZONE NOT NULL, "aula" text, CONSTRAINT "PK_bed2774da6b883bb80b9672d7ed" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "students" ADD CONSTRAINT "CHK_students_start_year" CHECK (student_start_year IS NULL OR (student_start_year >= 1990 AND student_start_year <= 2100))`
       );
       ...
       `);
       await queryRunner.query(
         `CREATE TABLE "subject_status_type" ("id" SERIAL NOT NULL, "status_name" text NOT NULL, CONSTRAINT "UQ_9d61379e0ce29796ab1f019f199" UNIQUE ("status_name"), CONSTRAINT "PK_b3784b0b05e5f78587a508bcfe1" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" ADD CONSTRAINT "CHK_partial_scores_is_object" CHECK ("partial_scores" IS NULL OR jsonb_typeof("partial_scores") = 'object')`
       );
       await queryRunner.query(
         `COMMENT ON COLUMN "student_subject_progress"."partial_scores" IS 'Validated and trimmed by trg_enforce_partial_scores trigger.'`
       );
       await queryRunner.query(
         `CREATE INDEX "IDX_5fef2a1967bce469e3d0cfa577" ON "student_subject_progress" ("student_id") `
       );
       await queryRunner.query(
         `CREATE UNIQUE INDEX "IDX_553c118da9bf0c4142b4b1920c" ON "student_subject_progress" ("subject_commission_id", "student_id") `
       );
       await queryRunner.query(
         `CREATE TABLE "careers" ("id" SERIAL NOT NULL, "career_name" text NOT NULL, "academic_period_id" integer NOT NULL, "preceptor_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_febfc45dc83d58090d3122fde3d" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
         `CREATE TABLE "career_subjects" ("id" SERIAL NOT NULL, "career_id" integer NOT NULL, "subject_id" integer NOT NULL, "year_no" smallint, "period_order" smallint, "order_no" integer NOT NULL, CONSTRAINT "PK_aebef84b8a7ca894169a6b50a24" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
         `CREATE INDEX "IDX_120deadc17ec96ea0da3a206c8" ON "career_subjects" ("subject_id") `
       );
       await queryRunner.query(
         `CREATE UNIQUE INDEX "IDX_0a093df398afe9f019dabba5e8" ON "career_subjects" ("career_id", "order_no") `
       );
       await queryRunner.query(
         `CREATE UNIQUE INDEX "IDX_687b5fc3eaab5b8a3aa41b0b02" ON "career_subjects" ("career_id", "subject_id") `
       );
       await queryRunner.query(
         `CREATE TABLE "subject_prerequisites_by_order" ("id" SERIAL NOT NULL, "career_id" integer NOT NULL, "subject_order_no" integer NOT NULL, "prereq_order_no" integer NOT NULL, CONSTRAINT "PK_a9abf00018f48dbfe485ce11a90" PRIMARY KEY ("id"))`
       );
       await queryRunner.query(
         `CREATE INDEX "IDX_50ee4f7f0b189aa1e7c449ef92" ON "subject_prerequisites_by_order" ("career_id", "prereq_order_no") `
       );
       await queryRunner.query(
         `CREATE INDEX "IDX_9cf580cc6862fe811d1f706167" ON "subject_prerequisites_by_order" ("career_id", "subject_order_no") `
       );
       await queryRunner.query(
         `CREATE UNIQUE INDEX "IDX_5056193f7e7e31a75f64f82dbe" ON "subject_prerequisites_by_order" ("career_id", "subject_order_no", "prereq_order_no") `
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "subject_commissions" ADD CONSTRAINT "FK_ad9281a6a38148ce7d9674a2a59" FOREIGN KEY ("subject_id") REFERENCES "subjects"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "subject_commissions" ADD CONSTRAINT "FK_b3b410787bedfa50358315cd538" FOREIGN KEY ("commission_id") REFERENCES "commission"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "subject_commissions" ADD CONSTRAINT "FK_e7e4849f084c18911c0dbbbc75a" FOREIGN KEY ("teacher_id") REFERENCES "teachers"("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "subjects" ADD CONSTRAINT "FK_2e4f2f1f2ddf59ba477a7e531de" FOREIGN KEY ("academic_period_id") REFERENCES "academic_period"("academic_period_id") ON DELETE NO ACTION ON UPDATE NO ACTION`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "exam_table" ADD CONSTRAINT "FK_exam_table_created_by_users" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" ADD CONSTRAINT "FK_466017be703ff67fe8ac8edf012" FOREIGN KEY ("final_exam_id") REFERENCES "final_exams"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" ADD CONSTRAINT "FK_61acdc5ce17ac680051378c0584" FOREIGN KEY ("status_id") REFERENCES "final_exam_status"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `DROP FUNCTION IF EXISTS enforce_partial_scores();`
       );
       await queryRunner.query(`
           ...
           `);
       await queryRunner.query(
         `DROP TRIGGER IF EXISTS "trg_enforce_partial_scores" ON "student_subject_progress";`
       );
       await queryRunner.query(`
       ...
       await queryRunner.query(`
           ...
           `);
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" ADD CONSTRAINT "FK_60613f37be9011642ff6a31f88c" FOREIGN KEY ("recorded_by") REFERENCES "teachers"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" ADD CONSTRAINT "FK_fd8365a5f6fa3355e79ec9d61d4" FOREIGN KEY ("approved_by") REFERENCES "secretaries"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "students" ADD CONSTRAINT "FK_d3f279d8d86937741d42867f40f" FOREIGN KEY ("commission") REFERENCES "commission"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" ADD CONSTRAINT "FK_f991f9825a87d94bd3a21bd74d8" FOREIGN KEY ("subject_commission_id") REFERENCES "subject_commissions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" ADD CONSTRAINT "FK_5fef2a1967bce469e3d0cfa5779" FOREIGN KEY ("student_id") REFERENCES "students"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" ADD CONSTRAINT "FK_bca4f03d4efe3e7b77715ea90b2" FOREIGN KEY ("status_id") REFERENCES "subject_status_type"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "careers" ADD CONSTRAINT "FK_c0a16a76beca291e2b89d1717af" FOREIGN KEY ("academic_period_id") REFERENCES "academic_period"("academic_period_id") ON DELETE NO ACTION ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "careers" ADD CONSTRAINT "FK_8fa45f1407e199a5061eb3f4281" FOREIGN KEY ("preceptor_id") REFERENCES "preceptors"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "career_subjects" ADD CONSTRAINT "FK_e3cfafdc32a121a61f4c42de10c" FOREIGN KEY ("career_id") REFERENCES "careers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "career_subjects" ADD CONSTRAINT "FK_120deadc17ec96ea0da3a206c8b" FOREIGN KEY ("subject_id") REFERENCES "subjects"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "subject_prerequisites_by_order" ADD CONSTRAINT "FK_245ca3fcaecc8a8e25dcae0d08f" FOREIGN KEY ("career_id") REFERENCES "careers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "career_students" ADD CONSTRAINT "FK_3dddb847f5033682c672a973199" FOREIGN KEY ("career_id") REFERENCES "careers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "career_students" ADD CONSTRAINT "FK_f625a148a289aaca8d89da6bb80" FOREIGN KEY ("student_id") REFERENCES "students"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "notices" ADD CONSTRAINT "FK_8edf397e84eebabdf5e5caae600" FOREIGN KEY ("visible_role_id") REFERENCES "roles"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
       );
       await queryRunner.query(
         `ALTER TABLE "notices" ADD CONSTRAINT "FK_5091560ec8975434a5add94c411" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
       );
       await queryRunner.query(
       ...
       const [{ id: secretaryRoleId }] = await queryRunner.query(
         `SELECT id FROM roles WHERE name = $1 LIMIT 1`,
         [secretaryRoleSlug]
       );
       if (!secretaryRoleId) {
         throw new Error(
           "InitSchema seed: no se pudo obtener id de rol secretary"
         );
       }
       // Crear usuario si no existe
       const existingSecretaryUsers = await queryRunner.query(
       ...
       if (existingSecretaryUsers.length === 0) {
         ...
         await queryRunner.query(
           ...
           [secretaryRoleId, secretaryUserId]
         );
       }
       if (!secretaryUserId) {
         throw new Error(
           "InitSchema seed: no se pudo determinar userId de secretario"
         );
       }
       // Insertar fila en secretaries si falta
       await queryRunner.query(
         `INSERT INTO secretaries(user_id, is_directive) VALUES($1,false) ON CONFLICT (user_id) DO NOTHING`,
         [secretaryUserId]
       );
     }
     ...
     public async down(queryRunner: QueryRunner): Promise<void> {
       ...
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" DROP CONSTRAINT IF EXISTS "CHK_partial_scores_is_object"`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "notices" DROP CONSTRAINT "FK_5091560ec8975434a5add94c411"`
       );
       await queryRunner.query(
         `ALTER TABLE "notices" DROP CONSTRAINT "FK_8edf397e84eebabdf5e5caae600"`
       );
       await queryRunner.query(
         `ALTER TABLE "career_students" DROP CONSTRAINT "FK_f625a148a289aaca8d89da6bb80"`
       );
       await queryRunner.query(
         `ALTER TABLE "career_students" DROP CONSTRAINT "FK_3dddb847f5033682c672a973199"`
       );
       await queryRunner.query(
         `ALTER TABLE "subject_prerequisites_by_order" DROP CONSTRAINT "FK_245ca3fcaecc8a8e25dcae0d08f"`
       );
       await queryRunner.query(
         `ALTER TABLE "career_subjects" DROP CONSTRAINT "FK_120deadc17ec96ea0da3a206c8b"`
       );
       await queryRunner.query(
         `ALTER TABLE "career_subjects" DROP CONSTRAINT "FK_e3cfafdc32a121a61f4c42de10c"`
       );
       await queryRunner.query(
         `ALTER TABLE "careers" DROP CONSTRAINT "FK_8fa45f1407e199a5061eb3f4281"`
       );
       await queryRunner.query(
         `ALTER TABLE "careers" DROP CONSTRAINT "FK_c0a16a76beca291e2b89d1717af"`
       );
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" DROP CONSTRAINT "FK_bca4f03d4efe3e7b77715ea90b2"`
       );
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" DROP CONSTRAINT "FK_5fef2a1967bce469e3d0cfa5779"`
       );
       await queryRunner.query(
         `ALTER TABLE "student_subject_progress" DROP CONSTRAINT "FK_f991f9825a87d94bd3a21bd74d8"`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "students" DROP CONSTRAINT "FK_d3f279d8d86937741d42867f40f"`
       );
       await queryRunner.query(
         `ALTER TABLE "students" DROP CONSTRAINT "FK_fb3eff90b11bddf7285f9b4e281"`
       );
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" DROP CONSTRAINT "FK_fd8365a5f6fa3355e79ec9d61d4"`
       );
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" DROP CONSTRAINT "FK_60613f37be9011642ff6a31f88c"`
       );
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" DROP CONSTRAINT "FK_61acdc5ce17ac680051378c0584"`
       );
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" DROP CONSTRAINT "FK_42368f30908e238aa7d9af5e949"`
       );
       await queryRunner.query(
         `ALTER TABLE "final_exams_students" DROP CONSTRAINT "FK_466017be703ff67fe8ac8edf012"`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `ALTER TABLE "subject_commissions" DROP CONSTRAINT "FK_e7e4849f084c18911c0dbbbc75a"`
       );
       await queryRunner.query(
         `ALTER TABLE "subject_commissions" DROP CONSTRAINT "FK_b3b410787bedfa50358315cd538"`
       );
       await queryRunner.query(
         `ALTER TABLE "subject_commissions" DROP CONSTRAINT "FK_ad9281a6a38148ce7d9674a2a59"`
       );
       await queryRunner.query(
       ...
       await queryRunner.query(
         `DROP INDEX "public"."IDX_5056193f7e7e31a75f64f82dbe"`
       );
       await queryRunner.query(
         `DROP INDEX "public"."IDX_9cf580cc6862fe811d1f706167"`
       );
       await queryRunner.query(
         `DROP INDEX "public"."IDX_50ee4f7f0b189aa1e7c449ef92"`
       );
       await queryRunner.query(`DROP TABLE "subject_prerequisites_by_order"`);
       await queryRunner.query(
         `DROP INDEX "public"."IDX_687b5fc3eaab5b8a3aa41b0b02"`
       );
       await queryRunner.query(
         `DROP INDEX "public"."IDX_0a093df398afe9f019dabba5e8"`
       );
       await queryRunner.query(
         `DROP INDEX "public"."IDX_120deadc17ec96ea0da3a206c8"`
       );
       await queryRunner.query(`DROP TABLE "career_subjects"`);
       await queryRunner.query(`DROP TABLE "careers"`);
       await queryRunner.query(
         `DROP INDEX "public"."IDX_553c118da9bf0c4142b4b1920c"`
       );
       await queryRunner.query(
         `DROP INDEX "public"."IDX_5fef2a1967bce469e3d0cfa577"`
       );
       ...
       await queryRunner.query(
         `DROP INDEX "public"."IDX_65608a94ff5905eb9bbcc3ce75"`
       );
       ...
       await queryRunner.query(
         `DROP INDEX "public"."IDX_b3074a12097b0e46d9a53d0aee"`
       );
       await queryRunner.query(
         `DROP INDEX "public"."IDX_ad9281a6a38148ce7d9674a2a5"`
       );
       await queryRunner.query(
         `DROP INDEX "public"."IDX_e7e4849f084c18911c0dbbbc75"`
       );
...
export class AutoMigration1761015167691 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "subject_students" ("id" SERIAL NOT NULL, "subject_id" integer NOT NULL, "student_id" uuid NOT NULL, "enrollment_date" date, CONSTRAINT "UQ_d7cccb0760404e6dd5ab7732eab" UNIQUE ("subject_id", "student_id"), CONSTRAINT "PK_b877fe7a23fc423266ce05fd3a1" PRIMARY KEY ("id"))`);
  ...
  await queryRunner.query(`CREATE TABLE "exam_table" ("id" SERIAL NOT NULL, "name" text NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "created_by" uuid, CONSTRAINT "PK_7f3870bb63b95ce8bc0a5256464" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "final_exams_students" ("id" SERIAL NOT NULL, "final_exam_id" integer NOT NULL, "student_id" uuid NOT NULL, "enrolled_at" TIMESTAMP WITH TIME ZONE, "score" numeric(4,2), "notes" text, "status_id" integer, "recorded_by" uuid, "recorded_at" TIMESTAMP WITH TIME ZONE, "approved_by" uuid, "approved_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_b7fdfdbde6b37992dbbc2824abc" PRIMARY KEY ("id"))`);

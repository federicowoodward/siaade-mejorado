...
export class AutoMigration1761015167691 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "registration_stage_type" ("id" SERIAL NOT NULL, "name" text NOT NULL, CONSTRAINT "UQ_f0dc596823d051afa6b67b2150e" UNIQUE ("name"), CONSTRAINT "PK_6bba8a33eb9848c68c93f5e9758" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "registration_stage" ("id" SERIAL NOT NULL, "career_id" integer NOT NULL, "type_id" integer NOT NULL, "period_label" text, "start_at" TIMESTAMP WITH TIME ZONE NOT NULL, "end_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_by" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "min_order_no" integer, "max_order_no" integer, CONSTRAINT "PK_947b26c02253f51a49e3006b274" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4855c75ab5abec13d2d533d3bf" ON "registration_stage" ("career_id", "type_id") `);
        await queryRunner.query(`CREATE TABLE "registration_enrollment" ("id" SERIAL NOT NULL, "stage_id" integer NOT NULL, "student_id" uuid NOT NULL, "subject_commission_id" integer NOT NULL, "enrolled_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_60a96556c4331a14adbac84f889" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c0e744c34de5f4d53c236fdd13" ON "registration_enrollment" ("subject_commission_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_58b76bc221d9f1527418275268" ON "registration_enrollment" ("student_id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_27360c688221941af8b7df7860" ON "registration_enrollment" ("stage_id", "student_id", "subject_commission_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "registration_stage" ADD CONSTRAINT "FK_03fa845ccc3664a3175deb6a948" FOREIGN KEY ("career_id") REFERENCES "careers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_stage" ADD CONSTRAINT "FK_6bba8a33eb9848c68c93f5e9758" FOREIGN KEY ("type_id") REFERENCES "registration_stage_type"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_stage" ADD CONSTRAINT "FK_c83f73b29548e8cf874a237896a" FOREIGN KEY ("created_by") REFERENCES "secretaries"("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_enrollment" ADD CONSTRAINT "FK_7db9afce1c60947ef2bfce296d4" FOREIGN KEY ("stage_id") REFERENCES "registration_stage"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_enrollment" ADD CONSTRAINT "FK_58b76bc221d9f15274182752687" FOREIGN KEY ("student_id") REFERENCES "students"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_enrollment" ADD CONSTRAINT "FK_c0e744c34de5f4d53c236fdd134" FOREIGN KEY ("subject_commission_id") REFERENCES "subject_commissions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "registration_enrollment" DROP CONSTRAINT "FK_c0e744c34de5f4d53c236fdd134"`);
        await queryRunner.query(`ALTER TABLE "registration_enrollment" DROP CONSTRAINT "FK_58b76bc221d9f15274182752687"`);
        await queryRunner.query(`ALTER TABLE "registration_enrollment" DROP CONSTRAINT "FK_7db9afce1c60947ef2bfce296d4"`);
        await queryRunner.query(`ALTER TABLE "registration_stage" DROP CONSTRAINT "FK_c83f73b29548e8cf874a237896a"`);
        await queryRunner.query(`ALTER TABLE "registration_stage" DROP CONSTRAINT "FK_6bba8a33eb9848c68c93f5e9758"`);
        await queryRunner.query(`ALTER TABLE "registration_stage" DROP CONSTRAINT "FK_03fa845ccc3664a3175deb6a948"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_27360c688221941af8b7df7860"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_58b76bc221d9f1527418275268"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c0e744c34de5f4d53c236fdd13"`);
        await queryRunner.query(`DROP TABLE "registration_enrollment"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4855c75ab5abec13d2d533d3bf"`);
        await queryRunner.query(`DROP TABLE "registration_stage"`);
        await queryRunner.query(`DROP TABLE "registration_stage_type"`);
